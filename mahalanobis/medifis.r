...
medifis <- read_excel("../datos.xls", sheet = "Medifis", skip = 2)
...
datos <- medifis[, -(1:2)]
dimension <- ncol(datos)
means <- colMeans(datos)
covariance_matrix <- cov(datos)
mahalanobis_distances <- mahalanobis(datos, means, covariance_matrix)
...
outliers_cutoff_99 <- datos[outliers_cutoff_99_indexes, ]
outliers_cutoff_97_5 <- datos[outliers_cutoff_97_5_indexes, ]
outliers_cutoff_95 <- datos[outliers_cutoff_95_indexes, ]
outliers_cutoff_90 <- datos[outliers_cutoff_90_indexes, ]
